	...
	public override void Start() {
		...
		*/
		quizArcherButton.onClick.AddListener(() =>  {d["quizArcherButton"]++;i++;
			question.text = questions [i];Debug.Log("ARCHER BUTTON CLICK" + d["quizArcherButton"]);});
		quizFighterButton.onClick.AddListener(() =>  {d["quizFighterButton"]++;i++;
			question.text = questions [i];Debug.Log("FIGHTER BUTTON CLICK" + d["quizFighterButton"]);});
		quizMagicianButton.onClick.AddListener(() =>  {d["quizMagicianButton"]++;i++;
			question.text = questions [i];Debug.Log("magician BUTTON CLICK" + d["quizMagicianButton"]);});
