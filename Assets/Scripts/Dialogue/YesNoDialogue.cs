...
public class YesNoDialogue : State
{
	...
	public override void Start() {
		...
		dialogue = new Dialogue ("Test");

		dialogue.DialogueDictionary.Add ("I'm so hungry i could eat an octorok!", new Dialogue ("fuck"));
		dialogue.DialogueDictionary.Add ("Betsey", new Dialogue ("bitches"));
		firstButtonText.text = dialogue.DialogueDictionary.Keys.First();
		secondButtonText.text = dialogue.DialogueDictionary.Keys.Last();
		firstButton.onClick.AddListener (() => Iterate(dialogue.DialogueDictionary[firstButtonText.text]));
		secondButton.onClick.AddListener (() => Iterate(dialogue.DialogueDictionary[secondButtonText.text]));
		Iterate (dialogue);
	}
	...
	public void Iterate(Dialogue d) {
		Debug.Log("i in iterate" + i);
		//question.text = dialogue.Dialogues[i];
		StartCoroutine(TypeText(d.DialogueString));
