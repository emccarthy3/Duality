...
public class HelpMenu : MonoBehaviour {
	...
	public void Moves(){
		ChangeButtonVisibility (false);
		descriptionText.text = "Attack 1: Does 1 base damage (more damage depending on battle and class type advantage (see: weapons triangle)).  Attack 2: Only has 50% chance of hitting but does 3 base damage. Attack 3:(earned in 2nd battle) 70% chance of hitting but deals effect damage, which decrements target's hp each turn. Attack 4: Its a suprise! Changes depending on class type";
	}
	//Diplays info on RP
	public void RP(){
		ChangeButtonVisibility (false);
